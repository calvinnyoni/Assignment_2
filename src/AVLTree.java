     ...
     * @version 3.1 depracted by Apache, but altered for additional use
     * @author Calvin Nyoni
     */
    @Deprecated
    public class AVLTree<T extends Comparable<T>> {
        ...
        /**
         *  Get the node whose element matches the search query
         * @return the node containing the element which was searched
         * returns null if no node has an element that matches the search element
         * Uses node's get function to achieve this.
         * @see Node#inOrder
         */
        public Node get(T searchElement) {
            Node searchNode = top.get(searchElement);
            return searchNode;
        }
         ...
         * Prints each node's element in the tree.
         * Uses node's inOrder function to achieve this.
         * @see Node#inOrder
         */
        public void inOrder() {
            top.inOrder();
        ...
        public class Node {
            ...
            /**
             * Get the node's left subtree/node
            ...
            /**
             * Get the node's right subtree/node
             * @return node's right node
             */
            ...
            /**
             * Traverse the node's subtree in order.
             * Prints each node's element in the subtree.
             */
            public void inOrder() {
            ...
            public Node get(T searchElement) {
                ...
                while (searchNode != null) {
                    //System.out.println(searchNode.getElement().toString());
                    int searchIndex = searchNode.element.compareTo(searchElement);
